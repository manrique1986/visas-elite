      ...
      <div className="w-full max-w-sm">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-[#0f2447] to-[#1a3a6b] px-8 py-8 text-center">
            ...
            <p className="text-white/60 text-sm mt-1">Sistema de Gestión de Casos</p>
          </div>

          {/* Body */}
          <div className="px-8 py-8">
            <h2 className="text-[#0f1e35] text-lg font-semibold text-center mb-2">
              Bienvenido de vuelta
            </h2>
            <p className="text-[#6b7a99] text-sm text-center mb-8">
